...
function M.groups(theme)
    ...
    return {
        ...
        DiagnosticUnderlineError = { undercurl = true, sp = theme.palette.red },
        DiagnosticUnderlineWarn = { undercurl = true, sp = theme.palette.yellow },
        DiagnosticUnderlineInfo = { undercurl = true, sp = theme.palette.blue },
        DiagnosticUnderlineHint = { undercurl = true, sp = theme.palette.cyan },
